...
public class MappingException extends  Exception {
     ...
     */
    public MappingException(String errorDescription) {
     ...
     */
    public MappingException(String errorDescription, String errorDetail) {
        super(errorDescription);
        this.errorDescription = errorDescription;
     ...
     */
    public MappingException(Throwable cause, String errorCode) {
        super(cause);
